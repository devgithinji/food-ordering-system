...
public class OrderApplicationServiceTest {
    ...
    private final UUID CUSTOMER_ID = UUID.fromString("d215b5f8-0249-4dc5-89a3-51df148cfb41");
    private final UUID RESTAURANT_ID = UUID.fromString("d215b5f8-0249-4dc5-89a3-51df148cfb45");
    private final UUID PRODUCT_ID = UUID.fromString("d215b5f8-0249-4dc5-89a3-51df148cfb48");
    ...
    public void init() {
        createOrderCommand = CreateOrderCommand.builder().customerId(CUSTOMER_ID)
                .restaurantId(RESTAURANT_ID).address(OrderAddress.builder()
                        .street("street_1")
                        .postalCode("1000AB")
                        .city("Paris")
                        .build())
